...
const NameDetails = (props) => {
    ...
    return (
        <View style={globalStyles.container}>
            <View style={{ flexDirection: 'row', marginTop: 32 / 852 * height, width: width ,marginLeft:20/852 *height}}>
                ...
                <View style={{ alignItems: 'center', width: width ,marginLeft:-30/852*height}}>
            ...
            <View style={{ width: width, marginTop: 150 / 852 * height }}>
                <TouchableOpacity style={{ alignSelf: 'flex-end', marginRight: 17 / 852 * height }}
            ...
            <View style={{ alignItems: 'center', flexDirection: 'column', marginTop: 123 / 852 * height, justifyContent: 'flex-end' }}>
