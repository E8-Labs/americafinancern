    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <View style={globalStyles.container}>
                ...
                <Text style={{ fontSize: 14 / 852 * height, fontWeight: '500', color: '#a7a7a7', marginBottom: 20 / 852 * height }}>
                    situation?
                </Text>
                        ...
                        situitions.map((item) =>
                            ...
                            >
                                <View style={{
                                    ...
                                    width: 357 / 393 * width, borderRadius: 20, marginTop: 20 / 852 * height
                                }}>
                                    <Text style={{ fontSize: 18 / 852 * height, fontWeight: '500', color: '#000' }}>{item.data}</Text>
                                    <View style={{
                                        height: 34 / 852 * height, width: 34 / 853 * height, borderRadius: 17/853 * height, justifyContent: 'center',
                                        backgroundColor: slected === item.id ? "#2468E8" : '#ececec'
                                    }}>
                                        <Image source={slected === item.id ? wightIcon : blackIcon}
                                            style={{
                                                height: 21 / 852 * height, width: 21 / 852 * height, alignSelf: 'center'
                                            }}
                                        />
                                    </View>
                                </View>
                ...
                <View style={{ flex: 0.5 }}>
                    ...
                    <View style={{ width: width, alignItems: 'flex-end', marginRight: 20, marginTop: 20 / 852 * height }}>
                        <TouchableOpacity style = {globalStyles.shahussdowStyle}
