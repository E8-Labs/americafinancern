    ...
    return (
        ...
        <View style={{ height: height, width: width }}>
            ...
            <View style={{ flexDirection: "column", alignItems: "center", }}>
                <Text style={{ textAlign: "center", fontWeight: "700", fontSize: 26 / 852 * height, color: "#000", marginTop: 27 / 852 * height }}>{obligation.debt}</Text>
            ...
            <View style={{ backgroundColor: "#ececec", borderRadius: 13 / 852 * height, flexDirection: "row", marginTop: 26 / 852 * height, alignItems: "center", marginLeft: 17 / 852 * height, marginRight: 17 / 852 * height }}>
                ...
                <TextInput style={{ flex: 1, fontSize: 14 / 852 * height, fontFamily: "PoppinsMedium", paddingRight: 7 / 852 * height }} keyboardType="numeric" autoFocus={true}
                    value={amount}
